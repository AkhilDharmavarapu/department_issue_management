      ...
      {selectedProject && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center p-4 z-50">
          <div className="bg-slate-800 rounded-2xl shadow-2xl p-6 max-w-2xl w-full max-h-[80vh] overflow-y-auto border border-green-500/20">
            ...
            <div className="mb-4 border-t border-green-500/20 pt-4">
              <h4 className="font-semibold text-white mb-3">💬 Updates ({selectedProject.updates?.length || 0})</h4>
              
              {updateError && (
                <div className="mb-3 p-2 bg-red-500/20 border border-red-500/50 text-red-300 rounded-lg text-sm">
                  {updateError}
                </div>
              )}
              ...
              <div className="mb-4 flex gap-2">
                ...
                <button
                  ...
                  className="bg-green-600 hover:bg-green-700 disabled:bg-green-600/50 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg text-sm font-semibold transition-all self-start"
                >
                  {postingUpdate ? '⏳' : '📤'}
                </button>
              </div>
